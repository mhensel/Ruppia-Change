...
#here is the data w TSS included (same as above but w TSS, which filters out pre 99 data for a few stations. USE THIS!)
...
Subestuary_WQ <- read.csv("/Volumes/savshare2/Current Projects/Ruppia/Data/RmSEM datasets/Subestuary_WQ.csv") #this comes from tidyCBPWQ data 2019.R
